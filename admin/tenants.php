                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    echo '
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="#">
                                            <i class="fa fa-trash"  data-toggle="modal" data-target="#responsive-modal'.$row["tenantID"].'" title="remove" style="color:red;"></i>
                                            <i class="fa fa-pencil" data-toggle="modal" data-target="#update-modal' . $row["tenantID"]  . '" title="Update" style="color:blue;"></i>
                                            </a>
                                            </td>
                                            ...
                                            <div id="responsive-modal'.$row["tenantID"].'" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        $row["email"].'"/>                                                            <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                                            ...
                                            <!-- Modal to edit. -->
                                            <div id="update-modal'.$row["tenantID"].'" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            <h4 class="modal-title">Edit '.$row["tenant_name"].'\'s record</h4>
                                                            </div>
                                                        <div class="modal-body">

                                                        <form action="functions/update_tenant.php" method="post">
                                                        <input type="hidden" name="tenID" value="'.
                                                        $row["tenantID"].'"/>
                                                        <input type="hidden" name="num" value="'.
                                                        $row["phone_number"].'"/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="tenant_name" value="' . $row["tenant_name"] . '" required>
                                                            <label for="email">Email</label>
                                                            <input type="email" class="form-control" name="email" value="' . $row["email"] . '" required>
                                                            <label for="id_number">ID Number</label>
                                                            <input type="text" class="form-control" name="id_number" value="' . $row["ID_number"] . '" required>
                                                            <label for="profession">Profession</label>
                                                            <input type="text" class="form-control" name="profession" value="' . $row["profession"] . '" required>
                                                            <label for="phone_number">Phone Number</label>
                                                            <input type="text" class="form-control" name="phone_number" value="' . $row["phone_number"] . '" required>
                                                        </div>
                                                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                                                        <button type="submit" name="editTenant" class="btn btn-danger waves-effect waves-light">Edit</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
