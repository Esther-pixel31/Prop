        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="#" class="waves-effect"><i class="fa fa-building fa-2x"></i> <span class="hide-menu"> || Property<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="new-house.php">Add a Property</a></li>
                            <li><a href="houses.php"> View Properties</a></li>
                        </ul>
                    </li>
                   
                   <li> <a href="#" class="waves-effect"><i class="fa fa-home fa-2x"></i> <span class="hide-menu"> || House No.<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="new-house-no.php">Add a House No. </a></li>
                            <li><a href="house-no.php"> View House No.</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="#" class="waves-effect"><i class="fa fa-tint fa-2x"></i> <span class="hide-menu"> || Billing <span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="new-water.php">Add Water Readings</a></li>
                            <li><a href="water.php">View Water Readings</a></li>
